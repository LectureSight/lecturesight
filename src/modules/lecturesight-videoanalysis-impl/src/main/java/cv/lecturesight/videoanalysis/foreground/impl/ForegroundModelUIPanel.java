...
public class ForegroundModelUIPanel extends javax.swing.JPanel {
  
  DisplayService dsps;
  
  ForegroundModelUIPanel(DisplayService dsps) {
    this.dsps = dsps;
    ...
    viewTabs.add("update", dsps.getDisplayBySID(Constants.WINDOWNAME_UPDATEMAP).getDisplayPanel());
    viewTabs.add("foreground", dsps.getDisplayBySID(Constants.WINDOWNAME_FOREGROUNDMAP).getDisplayPanel());
  }
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        outputPanelLayout.setVerticalGroup(
            outputPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(viewTabs, javax.swing.GroupLayout.DEFAULT_SIZE, 325, Short.MAX_VALUE)
        );
