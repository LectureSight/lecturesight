...
public class Constants {
  ...
  final static String PROPKEY_DISPLAY_DIFF = "background.display.diff";
  final static String PROPKEY_DISPLAY_MODEL = "background.display.model";
  final static String PROPKEY_DISPLAY_UPDATEMAP = "background.display.updatemap";
  final static String WINDOWNAME_DIFF = "bg.diff";
  final static String WINDOWNAME_MODEL = "bg.model";
  final static String WINDOWNAME_UPDATEMAP = "bg.updatemap";
