...
public class Constants {
	...
	final static String PROPKEY_ONVIF_CAMERA = "camera.host";
	final static String PROPKEY_ONVIF_USERNAME = "camera.username";
	final static String PROPKEY_ONVIF_PASSWORD = "camera.password";
