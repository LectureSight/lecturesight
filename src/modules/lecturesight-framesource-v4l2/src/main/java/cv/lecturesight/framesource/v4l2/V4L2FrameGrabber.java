...
public class V4L2FrameGrabber implements cv.lecturesight.framesource.FrameGrabber, CaptureCallback {
  ...
  V4L2FrameGrabber(VideoDevice device, int frameWidth, int frameHeight, int videoStandard,
