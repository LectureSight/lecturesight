...
public class Constants {
  ...
  final static String PROPKEY_PORT_DEVCICE = "port.device";
  final static String PROPKEY_PORT_SPEED = "port.speed";
  final static String PROPKEY_PORT_DATABITS = "port.databits";
