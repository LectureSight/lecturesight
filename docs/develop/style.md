...
* LectureSight uses the [maven checkstyle plugin](https://maven.apache.org/plugins/maven-checkstyle-plugin/) to enforce java code style. The checkstyle rules are defined in `src/docs/checkstyle/lecturesight-checkstyle.xml`
