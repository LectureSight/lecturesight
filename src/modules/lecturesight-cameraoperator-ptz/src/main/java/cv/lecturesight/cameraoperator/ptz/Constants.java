...
public class Constants {
  ...
  static final String PROPKEY_FRAME_HEIGHT = "frame.height";
  static final String PROPKEY_IDLE_PRESET = "idle.preset";
  static final String PROPKEY_TARGET_LIMIT = "target.limit";
  static final String PROPKEY_TILT_LOCK = "tilt.lock";
  static final String PROPKEY_TILT_OFFSET = "tilt.offset";
}
